...
type WebauthnCredentialSpecifics_PaymentsSupport int32

const (
	// Indicates that this credential cannot be used to authenticate a payment.
	WebauthnCredentialSpecifics_NONE WebauthnCredentialSpecifics_PaymentsSupport = 0
	// Indicates that the credential may authenticate a payment, but only for
	// the same RP ID (i.e. same site) that created it.
	WebauthnCredentialSpecifics_FIRST_PARTY WebauthnCredentialSpecifics_PaymentsSupport = 1
	// Indicates that the credential may authenticate a payment on any site.
	WebauthnCredentialSpecifics_FIRST_AND_THIRD_PARTY WebauthnCredentialSpecifics_PaymentsSupport = 2
)

// Enum value maps for WebauthnCredentialSpecifics_PaymentsSupport.
var (
	WebauthnCredentialSpecifics_PaymentsSupport_name = map[int32]string{
		0: "NONE",
		1: "FIRST_PARTY",
		2: "FIRST_AND_THIRD_PARTY",
	}
	WebauthnCredentialSpecifics_PaymentsSupport_value = map[string]int32{
		"NONE":                  0,
		"FIRST_PARTY":           1,
...
func (x WebauthnCredentialSpecifics_PaymentsSupport) Enum() *WebauthnCredentialSpecifics_PaymentsSupport {
	p := new(WebauthnCredentialSpecifics_PaymentsSupport)
	*p = x
	return p
}

func (x WebauthnCredentialSpecifics_PaymentsSupport) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WebauthnCredentialSpecifics_PaymentsSupport) Descriptor() protoreflect.EnumDescriptor {
	return file_webauthn_credential_specifics_proto_enumTypes[0].Descriptor()
}

func (WebauthnCredentialSpecifics_PaymentsSupport) Type() protoreflect.EnumType {
	return &file_webauthn_credential_specifics_proto_enumTypes[0]
}

func (x WebauthnCredentialSpecifics_PaymentsSupport) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *WebauthnCredentialSpecifics_PaymentsSupport) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = WebauthnCredentialSpecifics_PaymentsSupport(num)
	return nil
}

// Deprecated: Use WebauthnCredentialSpecifics_PaymentsSupport.Descriptor instead.
func (WebauthnCredentialSpecifics_PaymentsSupport) EnumDescriptor() ([]byte, []int) {
...
type WebauthnCredentialSpecifics struct {
	...
	PaymentsSupport *WebauthnCredentialSpecifics_PaymentsSupport `protobuf:"varint,10,opt,name=payments_support,json=paymentsSupport,enum=sync_pb.WebauthnCredentialSpecifics_PaymentsSupport" json:"payments_support,omitempty"`
}
...
func (x *WebauthnCredentialSpecifics) GetPaymentsSupport() WebauthnCredentialSpecifics_PaymentsSupport {
	if x != nil && x.PaymentsSupport != nil {
		return *x.PaymentsSupport
	}
	return WebauthnCredentialSpecifics_NONE
}
...
var file_webauthn_credential_specifics_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x70, 0x62, 0x22, 0x85,
	0x04, 0x0a, 0x1b, 0x57, 0x65, 0x62, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x43, 0x72, 0x65, 0x64, 0x65,
	...
	,
...
var file_webauthn_credential_specifics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_webauthn_credential_specifics_proto_goTypes = []interface{}{
	(WebauthnCredentialSpecifics_PaymentsSupport)(0), // 0: sync_pb.WebauthnCredentialSpecifics.PaymentsSupport
	(*WebauthnCredentialSpecifics)(nil),              // 1: sync_pb.WebauthnCredentialSpecifics
}
var file_webauthn_credential_specifics_proto_depIdxs = []int32{
	0, // 0: sync_pb.WebauthnCredentialSpecifics.payments_support:type_name -> sync_pb.WebauthnCredentialSpecifics.PaymentsSupport
