...
var file_nigori_local_data_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x22, 0xc3, 0x01, 0x0a, 0x11, 0x43, 0x72,
	0x79, 0x70, 0x74, 0x6f, 0x67, 0x72, 0x61, 0x70, 0x68, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x2e, 0x0a, 0x07, 0x6b, 0x65, 0x79, 0x5f, 0x62, 0x61, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x15, 0x2e, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x70, 0x62, 0x2e, 0x4e, 0x69, 0x67, 0x6f, 0x72,
...
var file_nigori_local_data_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_nigori_local_data_proto_goTypes = []interface{}{
	(*CrossUserSharingKeys)(nil),                  // 0: sync_pb.CrossUserSharingKeys
	(*CryptographerData)(nil),                     // 1: sync_pb.CryptographerData
	(*CustomPassphraseKeyDerivationParams)(nil),   // 2: sync_pb.CustomPassphraseKeyDerivationParams
	(*NigoriModel)(nil),                           // 3: sync_pb.NigoriModel
	(*NigoriLocalData)(nil),                       // 4: sync_pb.NigoriLocalData
	(*CrossUserSharingPrivateKey)(nil),            // 5: sync_pb.CrossUserSharingPrivateKey
	(*NigoriKeyBag)(nil),                          // 6: sync_pb.NigoriKeyBag
	(NigoriSpecifics_KeyDerivationMethod)(0),      // 7: sync_pb.NigoriSpecifics.KeyDerivationMethod
	(*EncryptedData)(nil),                         // 8: sync_pb.EncryptedData
	(NigoriSpecifics_PassphraseType)(0),           // 9: sync_pb.NigoriSpecifics.PassphraseType
	(*NigoriSpecifics_TrustedVaultDebugInfo)(nil), // 10: sync_pb.NigoriSpecifics.TrustedVaultDebugInfo
	(*CrossUserSharingPublicKey)(nil),             // 11: sync_pb.CrossUserSharingPublicKey
	(*ModelTypeState)(nil),                        // 12: sync_pb.ModelTypeState
	(*EntityMetadata)(nil),                        // 13: sync_pb.EntityMetadata
}
var file_nigori_local_data_proto_depIdxs = []int32{
	5,  // 0: sync_pb.CrossUserSharingKeys.private_key:type_name -> sync_pb.CrossUserSharingPrivateKey
	6,  // 1: sync_pb.CryptographerData.key_bag:type_name -> sync_pb.NigoriKeyBag
	0,  // 2: sync_pb.CryptographerData.cross_user_sharing_keys:type_name -> sync_pb.CrossUserSharingKeys
	7,  // 3: sync_pb.CustomPassphraseKeyDerivationParams.custom_passphrase_key_derivation_method:type_name -> sync_pb.NigoriSpecifics.KeyDerivationMethod
	1,  // 4: sync_pb.NigoriModel.cryptographer_data:type_name -> sync_pb.CryptographerData
	8,  // 5: sync_pb.NigoriModel.pending_keys:type_name -> sync_pb.EncryptedData
	9,  // 6: sync_pb.NigoriModel.passphrase_type:type_name -> sync_pb.NigoriSpecifics.PassphraseType
	2,  // 7: sync_pb.NigoriModel.custom_passphrase_key_derivation_params:type_name -> sync_pb.CustomPassphraseKeyDerivationParams
	8,  // 8: sync_pb.NigoriModel.pending_keystore_decryptor_token:type_name -> sync_pb.EncryptedData
	10, // 9: sync_pb.NigoriModel.trusted_vault_debug_info:type_name -> sync_pb.NigoriSpecifics.TrustedVaultDebugInfo
	11, // 10: sync_pb.NigoriModel.cross_user_sharing_public_key:type_name -> sync_pb.CrossUserSharingPublicKey
	12, // 11: sync_pb.NigoriLocalData.model_type_state:type_name -> sync_pb.ModelTypeState
	13, // 12: sync_pb.NigoriLocalData.entity_metadata:type_name -> sync_pb.EntityMetadata
	3,  // 13: sync_pb.NigoriLocalData.nigori_model:type_name -> sync_pb.NigoriModel
